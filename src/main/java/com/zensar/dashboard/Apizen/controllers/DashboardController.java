...
public class DashboardController {
	...
	/*
	 * @GetMapping("/test") public void saveDashboardConfiguration() {
	 * 
	 * // Dashboard bean DashboardBean dashboardBean = new DashboardBean();
	 * 
	 * // Grid bean GridBean gridBean= new GridBean();
	 * 
	 * // List of Card form a Grid bean ArrayList<CardBean> cardBeans=new
	 * ArrayList<>();
	 * 
	 * // Initiation of 1 Card CardBean cardBean= new CardBean();
	 * //cardBean.setCardID(101); cardBean.setCardName("Card 1");
	 * cardBean.setPosition(1);
	 * 
	 * // Initiation of CardComponent under a Card NotificationBean notificationBean
	 * = new NotificationBean(); notificationBean.setComponentType("notification");
	 * notificationBean.setMessage("Dummy Message");
	 * notificationBean.setXpath("xpath"); List<NotificationThresholdConfiguration>
	 * notificationThresholdConfigurations = new ArrayList<>();
	 * NotificationThresholdConfiguration notificationThresholdConfiguration=new
	 * NotificationThresholdConfiguration();
	 ...
	 * notificationBean.setNotificationThresholdConfigurations(
	 * notificationThresholdConfigurations);
	 * 
	 * cardBean.setCardComponentBean(notificationBean);
	 * 
	 * // Initiation of APIConfigurationBean under a Card APIConfigurationBean
	 * apiConfigurationBean= new APIConfigurationBean();
	 * 
	 * apiConfigurationBean.setUrl("https://");
	 * apiConfigurationBean.setThreshold(120);
	 * 
	 * // Initiation of HeaderMap under a apiConfigurationBean List<HeaderBean>
	 * headerMap= new ArrayList<HeaderBean>(); HeaderBean headerBean= new
	 * HeaderBean(); headerBean.setKey("Key"); headerBean.setValue("Value");
	 * headerMap.add(headerBean); apiConfigurationBean.setHeadersMap(headerMap);
	 * 
	 ...
	 * queryParameterBean.setKey("key"); queryParameterBean.setValue("value");
	 ...
	 * 
	 * gridBean.setCards(cardBeans); dashboardBean.setGridBean(gridBean);
	 * 
